	...
	<section id="contact" class="py-3">
        ...
        <section id="actions" class="py-4">
          <div class="container">
            <div class="row">
              <div class="col-md-2">
                <a href="QnaList.do" class="btn btn-light btn-block">
              ...
              <div class="col-md-2">
                <a href="QnaUpdate.do?p_id=${qna.p_id}&&cust_no=${qna.cust_no}" class="btn btn-success btn-block">
			        ...
			        <div class="col">
			          <div class="card">
			            ...
			            <div class="card-body">
			              ...
			              <div>
											<button id="btnDeleteReply" style="float:left" p_id="${qna.p_id}" cust_no="${qna.cust_no }">삭제</button>
											<button id="btnUpdateReply" style="float:left" p_id="${qna.p_id}" cust_no="${qna.cust_no }">수정</button>
