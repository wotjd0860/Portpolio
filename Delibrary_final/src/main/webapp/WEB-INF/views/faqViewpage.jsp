							...
							<section id="main_section">      
								<div class="faq" >
									...
									<div class="accordion">
										...
										<label for="answer01" class=" noto-serif">Q : 회원가입을 하면 편리한 점이 무엇인가요?</label>
										<div>
											<p class="m-0"><i class="fas fa-angle-right"></i>&nbsp;&nbsp;도서관 홈페이지 이용시 반복되던 신분확인 절차가 회원가입시 한번의 인증으로 간소화 됩니다.</p>
											<p class="m-0"><i class="fas fa-angle-right"></i>&nbsp;&nbsp;홈페이지에서 등록된 아이디로 간편하게 도서관 서비스 신청이 가능합니다.</p>
											<p class="m-0"><i class="fas fa-angle-right"></i>&nbsp;&nbsp;회원가입시 입력하신 관심 주제분야의 추천도서를 제공 받을 수 있습니다.</p>
											
										</div>
										<input type="radio" name="accordion" id="answer02"> 
										<label for="answer02" class="noto-serif">Q : 등록된 내 정보를 변경하고 싶습니다.</label>
										<div>
											<p class="m-0">Delibrary의 회원정보 변경은 고객님께서 직접 홈페이지 로그인 후</p>
											<p class="m-0">[마이페이지 > 회원정보 > 회원 정보 조회/수정] 에서 정보를 변경하실 수 있습니다.</p>
										</div>
										<input type="radio" name="accordion" id="answer03"> 
										<label for="answer03" class="noto-serif">Q : 탈퇴는 어떻게 하나요?</label>
										<div>
											<p class="m-0">Delibrary 홈페이지 로그인 => ‘회원정보수정’ => ‘회원탈퇴’ 메뉴 클릭</p>
										</div>	
									</div>
								</div>
							</section>
