		...
		<div class="container">
		  ...
		  <!-- 사이드바 -->
					...
					<c:forEach var="b" items="${b }"> 
				  	<div class="card">
					    <div class="card_image-holder">
				      	...
				      	<div id="book-title">${b.b_title }</div>
					    </div>
           ...
           <ul class="pagination justify-content-center">
             <li class="page-item"><a class="page-link" id="page-link" href="borrowList.do?pageNUM=${startPage-1 }">&laquo;</a></li>
                 <c:forEach var="i" begin="${startPage }" end="${endPage }">
              <li class="page-item "><a class="page-link" id="page-link" href="borrowList.do?pageNUM=${i }">${i }</a></li>
              </c:forEach>
             <li class="page-item"><a class="page-link" id="page-link" href="borrowList.do?pageNUM=${endPage+1 }">&raquo;</a></li>
           </ul>
         </div>
 			</div>
		</section>
