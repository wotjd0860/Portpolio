	        ...
	        <ul class="pagination justify-content-center">
	          <li class="page-item disabled">
        		...
        		<c:forEach var="i" begin="1" end="${totalPage }">
						<li class="page-item">
							<a href="postList.do?pageNUM=${i }&group=${group}" class="page-link">${i }</a>
						</li>
		        </c:forEach>
        		<li class="page-item">
            	<a class="page-link" href="#">
...
<!-- 				<nav> -->
<!-- 					<ul class="pagination justify-content-center"> -->
<%-- 						<li class="page-item disabled"><a class="page-link" id="page-link" href="postList.do?pageNUM=${startPage-1 }&group=${group}">&laquo;</a></li> --%>
<%-- 						<c:forEach var="i" begin="${startPage }" end="${endPage }"> --%>
<%-- 							<li class="page-item "><a class="page-link" id="page-link" href="postList.do?pageNUM=${i }&group=${group}">${i }</a></li> --%>
<%-- 						</c:forEach> --%>
<%-- 						<li class="page-item"><a class="page-link" id="page-link" href="postList.do?pageNUM=${endPage+1 }&group=${group}">&raquo;</a></li> --%>
<!-- 					</ul> -->
<!-- 				</nav> -->
