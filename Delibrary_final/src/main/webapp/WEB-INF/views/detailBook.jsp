        ...
        <div class="col">
          <div class="p-4">
            <div class="card-body">
              ...
              <div class="card-group">
                <div class="card" id="card-no-border">
                  <img id="b_image" class="img" src="img/${b.b_image }" alt=""style="margin-left: auto; margin-right: auto; display: block; height:100%;"/>
                </div>
			...
			<img width="85px" height="70px" alt="book image"
					...
					style='color: green; font-size: 15pt;'> 대출하시겠습니까? </span>
			</div>
            <!-- 내서재추가 클릭시 폴더 선택 화면 -->
