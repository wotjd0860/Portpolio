		  ...
		  <div class="row">
			...
			<div class="col-md-9">
         	...
         	<div class="col">
         	  ...
         	  <button class="btn btn-outline-success noto-serif" onclick="QnaInsert()" href="QnaInsert.do?cust_no=${cust_no}">글쓰기</button>
					</div>
					<div class="text-right mb-2">
						<form class="form-inline" action="QnaList.do" method="get" class="search">
							<div class="form-group noto-serif">
				...
				<tbody class="tbody text-center noto-sans">
					...
					<c:forEach var="p" items="${list }" begin="${startPage }" end="${endPage }">
						<tr>
				  ...
				  <c:if test="${startPage == 1}">
				    <li class="page-item disabled"><a class="page-link" id="page-link" href="QnaList.do?pageNUM=${startPage-1 }">&laquo;</a></li>
					  ...
					  <li class="page-item "><a class="page-link" id="page-link" href="QnaList.do?pageNUM=${i }">${i }</a></li>
					  </c:forEach>
