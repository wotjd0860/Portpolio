...
<!-- MAIN SECTION -->
		<section id="contact" class="py-3">
			<div class="container">
				<div class="row">
                  ...
                  <li class="list-group-item active"><a href="popularBook.do">이달의 인기도서</a></li>
               </ul>
						</div>
					</div>
								...
								<div class="col-md-3">
									<div class="card mb-3">
										<div class="card-body p-0">
											<img class="card-image-top img-fluid" width="100%" alt="${b.b_image }" src="${b.b_image }">
											<div class="card-body">
  ...
  <script type="text/javascript">
      window.onload = function() {
         ...
         const quotes = ['좋은 책은 인류에게 불멸의 정신이다. — J. 밀턴', '내가 인생을 알게 된 것은 사람과 접촉해서가 아니라 책과 접하였기 때문이다. — A. 프 랜스', '목적이 없는 독서는 산보일 뿐이다. — B. 리튼', '사람은 책을 만들고, 책은 사람을 만든다. — 신용호','기회를 기다리는 것은 바보짓이다. 독서의 시간이라는 것은 지금 이 시간이지 결코 이 제부터가 아니다. 오늘 읽을 수 있는 책을 내일로 넘기지 말라. — H. 잭슨','책은 한 권 한 권이 하나의 세계다. — W. 워즈워스', '책을 한 권 읽으면 한 권의 이익이 있고, 책을 하루 읽으면 하루의 이익이 있다. — 괴문절'];
