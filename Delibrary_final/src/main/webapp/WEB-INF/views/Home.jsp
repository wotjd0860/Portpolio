...
<body>
	<nav class="navbar sticky-top navbar-expand-sm navbar-light bg-light p-0">
		<div class="container container-fluid">
			<a href="Home.do" class="navbar-brand"><img alt="딜리브러리" src="img/home/logo_home.png" height="30" class="pl-3 mb-1"></a>
				  ...
				  <div class="container">
					<div class="input-group mb-3" id="home-searchbar">
						...
						<div class="input-group-append">
							<button class="btn btn-outline-light btn-lg px-5" type="button" id="search">&nbsp;&nbsp;&nbsp;<b>도서검색</b> &nbsp;&nbsp;&nbsp;</button>
						</div>
					</div>
			  </div>
				</div>
	...
	<section id="gallery" class="py-5">
		...
		<div class="hr-green">
		  ...
		  <div class="row mb-4 pt-5">
				<div class="event-link col-md-2 d-inline">
					<a href="https://www.nl.go.kr/">
						<img width="100" alt="국립중앙도서관" src="../img/home/logo_national_library_of_korea.png"><br>
					</a>
				</div>
				<div class="event-link col-md-2">
					<a href="https://lib.seoul.go.kr/">
						<img width="100" alt="서울도서관" src="../img/home/logo_seoul_metropolitan_library.png"><br>
					</a>
				</div>
				<div class="event-link col-md-2">
					<a href="https://www.nanet.go.kr/main.do">
						<img width="100" alt="국회도서관" src="../img/home/logo_national_assembly_library.png" >
					</a>
				</div>
				<div class="event-link col-md-2">
					<a href="https://jnlib.sen.go.kr/jnlib/index.do?getContextPath=">
						<img width="100" alt="종로도서관" src="../img/home/logo_jongno_city_library.png"><br>
					</a>
				</div>
				<div class="event-link col-md-2">
					<a href="https://www.ydplib.or.kr/intro/index.do">
						<img width="100" alt="영등포구립도서관" src="../img/home/logo_yeongdeungpo_library.png"><br>
					</a>
				</div>
				<div class="event-link col-md-2">
					<a href="https://www.nowonlib.kr/">
						<img width="100" alt="노원구 구립도서관" src="../img/home/logo_nowon_public_library.png"><br>
					</a>
				</div>
		  </div>
		</div>
	...
	<div class="container pb-5">
		<div class="row">
			...
			<div class="col-md-4 mb-3 noto-serif">
				<a href="addrViewpageAPI.do"><div class="home-tag mb-2"><img class="pr-4 m-0" alt="찾아오시는 길" src="../img/home/map.png" height="30px">찾아오시는 길</div></a>
				<a href="#"><div class="home-tag mb-2"><img class="pr-4 m-0" alt="찾아오시는 길" src="../img/home/telephone.png" height="30px">전화번호</div></a>	
				<a href="QnaList.do"><div class="home-tag mb-2"><img class="pr-4 m-0" alt="찾아오시는 길" src="../img/home/question.png" height="30px">묻고답하기</div></a>	
				<a href="faqViewpage.do"><div class="home-tag mb-0"><img class="pr-4 m-0" alt="찾아오시는 길" src="../img/home/faq.png" height="30px">자주묻는질문</div></a>	
			</div>
			<div class="col-md-4 mb-3">
				<!-- TESTIMONIALS -->
				<section id="showcase">
			...
			<div class="row">
					...
					<div class="home-table p-4">
						...
						<div class="row">
							...
							<div class="text-right mr-4">
								<a href="postList.do?option=p_title&search=&group=10"><small class="text-muted">전체보기 &gt;</small></a>
							</div>
						</div>
						</div>
				...
				<div class="home-table p-4">
					...
					<div class="row">
						...
						<div class="text-right mr-4">
							<a href="postList.do?option=p_title&search=&group=20"><small class="text-muted">전체보기 &gt;</small></a>
						</div>
					</div>
						</div>
					<table class="table table-hover">
				...
				<div class="col-md-4 mb-4 text-left">
					...
					<div class="row">
						...
						<div class="text-right mr-4">
							<a href="postList.do?option=p_title&search=&group=30"><small class="text-muted">전체보기 &gt;</small></a>
						</div>
					</div>
					</div>
					<table class="table table-hover">
